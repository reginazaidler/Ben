...
test('settings page edits and locally persists the profile', () => {
  ...
  assert.ok(html.includes('ניהול הפרופיל, החוגים וההעדפות במכשיר הזה'));
  ...
  assert.ok(html.includes('ניהול כל נתוני האתר'));
  ...
  assert.ok(html.includes('data-go="settings"><span>⚙️</span>ניהול'));
